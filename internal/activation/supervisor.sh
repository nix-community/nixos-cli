...
# invocations could have a chance of occuring and makes
...
exec 8>"$SWITCH_LOCKFILE" || {
	log "failed to map fd 8 to $LOCKFILE"
	exit 1
}
...
# Signal to callers that switch-to-configuration has been ran, and
